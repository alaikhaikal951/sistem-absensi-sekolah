    ...
    <div class="col-lg-12">
        <div class="panel panel-primary">
            ...
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="media.php?module=siswa_senin">Senin</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="media.php?module=siswa_selasa">Selasa</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="media.php?module=siswa_rabu">Rabu</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="media.php?module=siswa_kamis">Kamis</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="media.php?module=siswa_jumat">Jum'at</a>
                </li>
            </ul>
            <br>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            $sql = mysqli_query($conn, "select jadwal.idj , hari.hari , guru.nama AS nama_guru, mata_pelajaran.nama_mp
...
ORDER BY jadwal.jam_mulai");
                            ...
                            ?> <tr class="odd gradeX">
                                    ...
                                    <td><a href="./././media.php?module=rekap_s&idj=<?php echo $rs['idj'] ?>"><button type="button" class="btn btn-outline-primary">Data Absen</button></a></td>
                                </tr>
                            <?php
                                $no++;
                            }
