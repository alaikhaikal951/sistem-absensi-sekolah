    ...
    <div class="col-lg-12">
        <div class="panel panel-primary">
            ...
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link" href="media.php?module=siswa_senin">Senin</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="media.php?module=siswa_jumat">Jum'at</a>
                </li>
            </ul>
            <br>
...
AND jadwal.idh=5 AND jadwal.idk='$rs[idk]'
