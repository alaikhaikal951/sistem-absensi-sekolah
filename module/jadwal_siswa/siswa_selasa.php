    ...
    <div class="col-lg-12">
        <div class="panel panel-primary">
            ...
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="media.php?module=siswa_senin">Senin</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active"  aria-current="page" href="media.php?module=siswa_selasa">Selasa</a>
                </li>
                <li class="nav-item">
...
AND jadwal.idh=2 AND jadwal.idk='$rs[idk]'
