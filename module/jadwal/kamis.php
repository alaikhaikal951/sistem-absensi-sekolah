                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="media.php?module=kamis">Kamis</a>
                            </li>
                            <li class="nav-item">
...
, jadwal.jam_selesai, jadwal.jam_mulai from jadwal,hari,kelas,guru,mata_pelajaran WHERE jadwal.idh=hari.idh AND jadwal.idk=kelas.idk AND jadwal.idg=guru.idg AND jadwal.idm=mata_pelajaran.idm AND jadwal.idh=4
