                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <ul class="nav nav-tabs">
                            <li role="presentation" class="active"><a href="media.php?module=senin">Senin</a></li>
  ...
  , jadwal.jam_selesai, jadwal.jam_mulai from jadwal,hari,kelas,guru,mata_pelajaran WHERE jadwal.idh=hari.idh AND jadwal.idk=kelas.idk AND jadwal.idg=guru.idg AND jadwal.idm=mata_pelajaran.idm AND jadwal.idh=1
  ORDER BY jadwal.jam_mulai");
                                        ...
                                        ?> <tr class="odd gradeX">
                                                ...
                                                <td class="text-center"><a href="./././media.php?module=input_jadwal&act=edit_jadwal&idj=<?php echo $rs['idj'] ?>"><button type="button" class="btn btn-info">Edit</button></a>
                                                    <a href="././module/simpan.php?act=hapus_jadwal&idj=<?php echo $rs['idj'] ?>"><button type="button" class="btn btn-danger">Hapus</button></a>
                                                </td>
                                            </tr>
                                        <?php
                                            $no++;
