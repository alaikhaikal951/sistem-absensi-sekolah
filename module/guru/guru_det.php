    ...
    <div class="col-lg-12">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <?php
                $sql = mysqli_query($conn, "select * from guru where nip='$_SESSION[idu]'");
                $rs = mysqli_fetch_array($sql);
                ?>

                <form method="post" class="row" role="form" action="././module/simpan.php?act=guru_det">
                    <input type="hidden" name="idg" value="<?php echo $rs['idg'] ?>" />
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label>NIP : <?php echo "$rs[nip]"; ?></label>
                        </div>
                        <div class="form-group">
                            <label>Nama</label>
