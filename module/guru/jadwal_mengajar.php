                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            $sql = mysqli_query($conn, "select jadwal.idj , hari.hari , kelas.nama AS nama_kelas, guru.idg AS id_guru, mata_pelajaran.nama_mp
...
AND guru.idg='$rs[idg]' ORDER BY jadwal.idh ASC");
                            ...
                            ?> <tr class="odd gradeX">
                                    ...
                                    <td class="text-center" style="width: 265px;">
                                        <a href="./././media.php?module=absen&idj=<?php echo $rs['idj'] ?>"><button type="button" class="btn btn-info">Mulai Absen</button></a>
