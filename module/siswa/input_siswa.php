        ...
        <div class="col-lg-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form method="post" class="row" role="form" action="././module/simpan.php?act=input_siswa">
                        <div class="col-lg-6">
        ...
        <div class="col-lg-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <form method="post" class="row" role="form" action="././module/simpan.php?act=edit_siswa">
